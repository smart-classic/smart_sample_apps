function Jash(existingParent) {
	/* location of source code (used to find css file) */
	this.jashRoot = "./";
	this.parentElementID = "JashParent";
	if (existingParent !== undefined) this.parentElementID = existingParent.id;
	...
	*/
	...
	this.doDomInserts = function() {
		...
		self.stylesheet.href=self.jashRoot +'stylesheets/jash.css';
		self.create();
	}
	...
	*/
	this.print = function(text,clear,suppressLineNumbers,autoscroll) {
		...
		if(this.output == null || document.getElementById(this.parentElementID) == null) {
			this.create();
			this.output = document.getElementById("JashOutput");
			this.mainBlock = document.getElementById(this.parentElementID);
		}
		if(clear) {
			this.clear();
		}
	...
	*/
	this.create = function() {
		...
		var debugParent = existingParent;
		var createdDebugParent = false;
		if (debugParent === undefined) {
		    debugParent = document.createElement("div");
		    createdDebugParent = true;
		}
		...
		debugParent.id = this.parentElementID;
