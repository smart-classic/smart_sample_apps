// Autogenerated version (not guaranteed to be sequential): 0.4.1.gcb90
...
SMART_CONNECT_CLIENT.prototype.MEDICATION_LISTS_get = function(callback_success, callback_error) {
    var _this = this,
        dfd = $.Deferred(),
        prm = dfd.promise();
    prm.success = prm.done;
...
SMART_CONNECT_CLIENT.prototype.register_method ("MEDICATION_LISTS_get",
                  "GET", 
                  "http://smartplatforms.org/terms#MedicationList",
                  "record_items");

SMART_CONNECT_CLIENT.prototype.MEDICATION_LIST_get = function(medication_list_id, callback_success, callback_error) {
    var _this = this,
        dfd = $.Deferred(),
        prm = dfd.promise();
    prm.success = prm.done;
    ...
    this.api_call({
        method: 'GET',
        url: "/records/" + _this.record.id + "/medication_lists/" + medication_list_id
    }, function(r) {
        var rdf;
        try {
            rdf = _this.process_rdf(r.contentType, r.body);
...
SMART_CONNECT_CLIENT.prototype.register_method ("MEDICATION_LIST_get",
                  "GET", 
                  "http://smartplatforms.org/terms#MedicationList",
                  "record_item");
