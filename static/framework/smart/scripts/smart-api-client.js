// Autogenerated version (not guaranteed to be sequential): 0.4.1.206.g9a30
// Autogenerated by concantenating several files: 
// DO NOT EDIT. 
// cat ie8fix.js json2.js ../../jquery/jquery.js jquery-ui.js  jquery.rdfquery.core-1.0.js jschannel.js smart-api-client-base.js  > smart-api-client.js
(function(window){
...
SMART_CONNECT_CLIENT.prototype.MANIFEST_get = function(callback_success, callback_error) {
...
SMART_CONNECT_CLIENT.prototype.PREFERENCES_delete = function(callback_success, callback_error) {
        ...
        return this.api_call_wrapper({
            method: "DELETE",
            path: "/users/"+this.user.id+"/apps/"+this.manifest.id+"/preferences",
            responseFormat: "None",
            success: callback_success,
            failure: callback_error,
            data: undefined,
