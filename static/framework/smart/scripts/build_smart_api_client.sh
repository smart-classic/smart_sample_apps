...
echo "// cat ie8fix.js json2.js ../../jquery/jquery.js jquery-ui.js  jquery.rdfquery.core-1.0.js jschannel.js smart-api-client-base.js  > smart-api-client.js"  >> smart-api-client.js
...
cat ie8fix.js >> smart-api-client.js
cat json2.js >> smart-api-client.js
